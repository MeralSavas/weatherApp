...
localStorage.setItem(
  "tokenKey",
  "Ksh4UOX3al4BuN+B4iRfBz5v0MOmTjqC6N5sJJE6/fB7B3GuE2Ok5W46t1UUKY9T"
);

// localStorage.setItem(
//   "tokenKeyEncrypted",
//   EncryptStringAES("14225bec0786d0a4d13271772b7f86ca")
// );
...
const getWeatherDataFromApi = async () => {
  ...
  try {
    ...
    //obj destr.
    const { main, sys, weather, name, icon } = response.data;
